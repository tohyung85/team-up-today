class ProfilesController < ApplicationController
  ...
  def profile_params
    ...
    params.require(:profile).permit(:first_name, :last_name, :avatar, :group_type_interests, languages_attributes: [:id, :name, :_destroy], skills_attributes: [:id, :name, :_destroy])
  end
end
